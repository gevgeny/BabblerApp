...
#ifndef BABBLER_SWIFT_H
#define BABBLER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Babbler",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Babbler11AppDelegate")
@interface AppDelegate : NSObject <NSApplicationDelegate>
- (void)applicationDidFinishLaunching:(NSNotification * _Nonnull)aNotification;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC7Babbler10ImageUtils")
@interface ImageUtils : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC7Babbler13KeyboardUtils")
@interface KeyboardUtils : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC7Babbler13LanguageUtils")
@interface LanguageUtils : NSObject
+ (void)change;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC7Babbler18SecurityInputUtils")
@interface SecurityInputUtils : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSMenuItem;
SWIFT_CLASS("_TtC7Babbler20StatusItemController")
@interface StatusItemController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)onLanguageItemSelect:(NSMenuItem * _Nonnull)targetMenuItem;
- (void)onIndicatorStyleChanged;
- (void)quit;
- (void)openSettings;
@end

SWIFT_CLASS("_TtC7Babbler14WorkspaceUtils")
@interface WorkspaceUtils : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
